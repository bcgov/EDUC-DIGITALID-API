...
-- Column Comments
COMMENT ON COLUMN STUDENT.Student.Student_ID IS 'Unique surrogate key for each Student. Generated as an identity/sequence value';
...
COMMENT ON COLUMN STUDENT.Digital_Identity.Digital_Identity_ID IS 'Unique surrogate key for each Digital Identity. Generated as an identity/sequence value.';
...
COMMENT ON COLUMN STUDENT.PEN_Retrieval_Request.PEN_Retrieval_Request_ID IS 'Unique surrogate key for each PEN Retrieval request. Generated as an identity/sequence value.';
